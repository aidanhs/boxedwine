...
#ifdef _NTSYSTEM_
__declspec(dllexport) void _chkstk();
#else
__declspec(dllimport) void _chkstk();
#endif
...
#pragma warning( disable : 4244 4018 4146 4090 4101 4715 4996)
...
#define PACKAGE_STRING "Windows On Dos"
...
/* Define to a macro to generate an assembly function with stdcall calling
   convention */
#define __ASM_STDCALL_FUNC(a, b, c) /* */
