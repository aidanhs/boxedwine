 ...
 */
/* Compiler settings for ..\..\..\..\wine\include\propidl.idl:
...
const CInterfaceProxyVtbl * const _propidl_ProxyVtblList[] = 
{
...
const CInterfaceStubVtbl * const _propidl_StubVtblList[] = 
{
