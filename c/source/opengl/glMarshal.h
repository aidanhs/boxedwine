...
#define marshalsz(cpu, address) (GLchar*)getPhysicalAddress(cpu->memory, address)
...
#define marshalPixel(cpu, format, type, pixel) (GLvoid*)getPhysicalAddress(cpu->memory, pixel)
