...
U32 null_read(MMU_ARG struct FsOpenNode* node, U32 address, U32 len) {
    return 0;
}

U32 null_write(MMU_ARG struct FsOpenNode* node, U32 address, U32 len) {
    return len;
}
...
U32 null_map(MMU_ARG struct FsOpenNode* node, U32 address, U32 len, S32 prot, S32 flags, U64 off) {
    return 0;
}
