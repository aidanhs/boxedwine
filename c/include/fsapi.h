...
struct FsOpenNodeFunc {
    ...
    U32  (*read)(MMU_ARG struct FsOpenNode* node, U32 address, U32 len);
    U32  (*write)(MMU_ARG struct FsOpenNode* node, U32 address, U32 len);
    void (*close)(struct FsOpenNode* node);
    U32  (*map)(MMU_ARG struct FsOpenNode* node, U32 address, U32 len, S32 prot, S32 flags, U64 off);
