    ...
    FILETIME *lpFileTime, BOOL islocal )
{
    ...
    if (pTZinfo->DaylightDate.wMonth != 0)
    {
        ...
        FileTimeToSystemTime_k(lpFileTime, &SysTime);
        year = SysTime.wYear;
...
{
    FILETIME ftTime;
    GetSystemTimeAsFileTime_k( &ftTime);
 ...
 */
BOOL WINAPI SetLocalTime_k( const SYSTEMTIME *systime )
{
    return TRUE;
}
 ...
 */
BOOL WINAPI GetSystemTimeAdjustment_k( PDWORD lpTimeAdjustment, PDWORD lpTimeIncrement,
    PBOOL  lpTimeAdjustmentDisabled )
{
    *lpTimeAdjustment = 0;
    *lpTimeIncrement = 100000;
 ...
 *           permission to change the time.
 */
BOOL WINAPI SetSystemTime_k( const SYSTEMTIME *systime )
{
    return TRUE;
}
 ...
 *  Failure: FALSE.
 */
BOOL WINAPI SetSystemTimeAdjustment_k( DWORD dwTimeAdjustment, BOOL bTimeAdjustmentDisabled )
{
...
DWORD WINAPI GetTimeZoneInformation_k( LPTIME_ZONE_INFORMATION tzinfo )
{
    ...
    status = RtlQueryTimeZoneInformation_k( (RTL_TIME_ZONE_INFORMATION*)tzinfo );
 ...
 *  Failure: FALSE.
 */
BOOL WINAPI SetTimeZoneInformation_k( const TIME_ZONE_INFORMATION *tzinfo )
{
    return TRUE;
}
...
BOOL WINAPI SystemTimeToTzSpecificLocalTime_k(
    ...
    const SYSTEMTIME *lpUniversalTime, LPSYSTEMTIME lpLocalTime )
{
    ...
    {
        if (GetTimeZoneInformation_k(&tzinfo) == TIME_ZONE_ID_INVALID)
            return FALSE;
    }

    if (!SystemTimeToFileTime_k(lpUniversalTime, &ft))
        return FALSE;
    ...
    return FileTimeToSystemTime_k(&ft, lpLocalTime);
}
 ...
 *  Failure: FALSE.
 */
BOOL WINAPI TzSpecificLocalTimeToSystemTime_k(
    const TIME_ZONE_INFORMATION *lpTimeZoneInformation,
    const SYSTEMTIME *lpLocalTime, LPSYSTEMTIME lpUniversalTime)
{
    ...
    if (!SystemTimeToFileTime_k(lpLocalTime, &ft))
        return FALSE;
    FILETIME2LL( &ft, t)
    ...
    LL2FILETIME( t, &ft)
    return FileTimeToSystemTime_k(&ft, lpUniversalTime);
}
 ...
 *   Nothing.
 */
VOID WINAPI GetSystemTimeAsFileTime_k(
    LPFILETIME time) /* [out] Destination for the current utc time */
{
    LARGE_INTEGER t;
    NtQuerySystemTime_k( &t );
 ...
 */
BOOL WINAPI GetProcessTimes_k( HANDLE hprocess, LPFILETIME lpCreationTime,
    LPFILETIME lpExitTime, LPFILETIME lpKernelTime, LPFILETIME lpUserTime )
{
    // :TODO:
    printf("GetProcessTimes not implemented\n");
    return TRUE;
}
 ...
 *
 */
int WINAPI GetCalendarInfoA_k(LCID lcid, CALID Calendar, CALTYPE CalType,
 ...
 *
 */
int WINAPI GetCalendarInfoW_k(LCID Locale, CALID Calendar, CALTYPE CalType,
			    LPWSTR lpCalData, int cchData, LPDWORD lpValue)
{
	...
	case CAL_ICALINTVALUE:
            if (CalType & CAL_RETURN_NUMBER)
                return GetLocaleInfoW_k(Locale, LOCALE_RETURN_NUMBER | LOCALE_ICALENDARTYPE,
                        (LPWSTR)lpValue, 2);
            return GetLocaleInfoW_k(Locale, LOCALE_ICALENDARTYPE, lpCalData, cchData);
	case CAL_SCALNAME:
	...
	case CAL_SERASTRING:
	    ...
	    return 0;
	case CAL_SSHORTDATE:
	    return GetLocaleInfoW_k(Locale, LOCALE_SSHORTDATE, lpCalData, cchData);
	case CAL_SLONGDATE:
	    return GetLocaleInfoW_k(Locale, LOCALE_SLONGDATE, lpCalData, cchData);
	case CAL_SDAYNAME1:
	    return GetLocaleInfoW_k(Locale, LOCALE_SDAYNAME1, lpCalData, cchData);
	case CAL_SDAYNAME2:
	    return GetLocaleInfoW_k(Locale, LOCALE_SDAYNAME2, lpCalData, cchData);
	case CAL_SDAYNAME3:
	    return GetLocaleInfoW_k(Locale, LOCALE_SDAYNAME3, lpCalData, cchData);
	case CAL_SDAYNAME4:
	    return GetLocaleInfoW_k(Locale, LOCALE_SDAYNAME4, lpCalData, cchData);
	case CAL_SDAYNAME5:
	    return GetLocaleInfoW_k(Locale, LOCALE_SDAYNAME5, lpCalData, cchData);
	case CAL_SDAYNAME6:
	    return GetLocaleInfoW_k(Locale, LOCALE_SDAYNAME6, lpCalData, cchData);
	case CAL_SDAYNAME7:
	    return GetLocaleInfoW_k(Locale, LOCALE_SDAYNAME7, lpCalData, cchData);
	case CAL_SABBREVDAYNAME1:
	    return GetLocaleInfoW_k(Locale, LOCALE_SABBREVDAYNAME1, lpCalData, cchData);
	case CAL_SABBREVDAYNAME2:
	    return GetLocaleInfoW_k(Locale, LOCALE_SABBREVDAYNAME2, lpCalData, cchData);
	case CAL_SABBREVDAYNAME3:
	    return GetLocaleInfoW_k(Locale, LOCALE_SABBREVDAYNAME3, lpCalData, cchData);
	case CAL_SABBREVDAYNAME4:
	    return GetLocaleInfoW_k(Locale, LOCALE_SABBREVDAYNAME4, lpCalData, cchData);
	case CAL_SABBREVDAYNAME5:
	    return GetLocaleInfoW_k(Locale, LOCALE_SABBREVDAYNAME5, lpCalData, cchData);
	case CAL_SABBREVDAYNAME6:
	    return GetLocaleInfoW_k(Locale, LOCALE_SABBREVDAYNAME6, lpCalData, cchData);
	case CAL_SABBREVDAYNAME7:
	    return GetLocaleInfoW_k(Locale, LOCALE_SABBREVDAYNAME7, lpCalData, cchData);
	case CAL_SMONTHNAME1:
	    return GetLocaleInfoW_k(Locale, LOCALE_SMONTHNAME1, lpCalData, cchData);
	case CAL_SMONTHNAME2:
	    return GetLocaleInfoW_k(Locale, LOCALE_SMONTHNAME2, lpCalData, cchData);
	case CAL_SMONTHNAME3:
	    return GetLocaleInfoW_k(Locale, LOCALE_SMONTHNAME3, lpCalData, cchData);
	case CAL_SMONTHNAME4:
	    return GetLocaleInfoW_k(Locale, LOCALE_SMONTHNAME4, lpCalData, cchData);
	case CAL_SMONTHNAME5:
	    return GetLocaleInfoW_k(Locale, LOCALE_SMONTHNAME5, lpCalData, cchData);
	case CAL_SMONTHNAME6:
	    return GetLocaleInfoW_k(Locale, LOCALE_SMONTHNAME6, lpCalData, cchData);
	case CAL_SMONTHNAME7:
	    return GetLocaleInfoW_k(Locale, LOCALE_SMONTHNAME7, lpCalData, cchData);
	case CAL_SMONTHNAME8:
	    return GetLocaleInfoW_k(Locale, LOCALE_SMONTHNAME8, lpCalData, cchData);
	case CAL_SMONTHNAME9:
	    return GetLocaleInfoW_k(Locale, LOCALE_SMONTHNAME9, lpCalData, cchData);
	case CAL_SMONTHNAME10:
	    return GetLocaleInfoW_k(Locale, LOCALE_SMONTHNAME10, lpCalData, cchData);
	case CAL_SMONTHNAME11:
	    return GetLocaleInfoW_k(Locale, LOCALE_SMONTHNAME11, lpCalData, cchData);
	case CAL_SMONTHNAME12:
	    return GetLocaleInfoW_k(Locale, LOCALE_SMONTHNAME12, lpCalData, cchData);
	case CAL_SMONTHNAME13:
	    return GetLocaleInfoW_k(Locale, LOCALE_SMONTHNAME13, lpCalData, cchData);
	case CAL_SABBREVMONTHNAME1:
	    return GetLocaleInfoW_k(Locale, LOCALE_SABBREVMONTHNAME1, lpCalData, cchData);
	case CAL_SABBREVMONTHNAME2:
	    return GetLocaleInfoW_k(Locale, LOCALE_SABBREVMONTHNAME2, lpCalData, cchData);
	case CAL_SABBREVMONTHNAME3:
	    return GetLocaleInfoW_k(Locale, LOCALE_SABBREVMONTHNAME3, lpCalData, cchData);
	case CAL_SABBREVMONTHNAME4:
	    return GetLocaleInfoW_k(Locale, LOCALE_SABBREVMONTHNAME4, lpCalData, cchData);
	case CAL_SABBREVMONTHNAME5:
	    return GetLocaleInfoW_k(Locale, LOCALE_SABBREVMONTHNAME5, lpCalData, cchData);
	case CAL_SABBREVMONTHNAME6:
	    return GetLocaleInfoW_k(Locale, LOCALE_SABBREVMONTHNAME6, lpCalData, cchData);
	case CAL_SABBREVMONTHNAME7:
	    return GetLocaleInfoW_k(Locale, LOCALE_SABBREVMONTHNAME7, lpCalData, cchData);
	case CAL_SABBREVMONTHNAME8:
	    return GetLocaleInfoW_k(Locale, LOCALE_SABBREVMONTHNAME8, lpCalData, cchData);
	case CAL_SABBREVMONTHNAME9:
	    return GetLocaleInfoW_k(Locale, LOCALE_SABBREVMONTHNAME9, lpCalData, cchData);
	case CAL_SABBREVMONTHNAME10:
	    return GetLocaleInfoW_k(Locale, LOCALE_SABBREVMONTHNAME10, lpCalData, cchData);
	case CAL_SABBREVMONTHNAME11:
	    return GetLocaleInfoW_k(Locale, LOCALE_SABBREVMONTHNAME11, lpCalData, cchData);
	case CAL_SABBREVMONTHNAME12:
	    return GetLocaleInfoW_k(Locale, LOCALE_SABBREVMONTHNAME12, lpCalData, cchData);
	case CAL_SABBREVMONTHNAME13:
	    return GetLocaleInfoW_k(Locale, LOCALE_SABBREVMONTHNAME13, lpCalData, cchData);
	case CAL_SYEARMONTH:
	    return GetLocaleInfoW_k(Locale, LOCALE_SYEARMONTH, lpCalData, cchData);
 ...
 *
 */
int WINAPI	SetCalendarInfoW_k(LCID Locale, CALID Calendar, CALTYPE CalType, LPCWSTR lpCalData)
{
    FIXME("(%08x,%08x,%08x,%s): stub\n",
 ...
 */
BOOL WINAPI LocalFileTimeToFileTime_k( const FILETIME *localft, LPFILETIME utcft )
{
    NTSTATUS status;
    ...
    if (!(status = RtlLocalTimeToSystemTime_k( &local, &utc )))
    {
 ...
 */
BOOL WINAPI FileTimeToLocalFileTime_k( const FILETIME *utcft, LPFILETIME localft )
{
    NTSTATUS status;
    LARGE_INTEGER local, utc;
    ...
    if (!(status = RtlSystemTimeToLocalTime_k( &utc, &local )))
    {
 ...
 *  than y respectively.
 */
INT WINAPI CompareFileTime_k( const FILETIME *x, const FILETIME *y )
{
    if (!x || !y) return -1;
 ...
 *  Nothing.
 */
VOID WINAPI GetLocalTime_k(LPSYSTEMTIME systime)
{
    FILETIME lft;
    LARGE_INTEGER ft, ft2;

    NtQuerySystemTime_k(&ft);
    RtlSystemTimeToLocalTime_k(&ft, &ft2);
    lft.dwLowDateTime = ft2.u.LowPart;
    lft.dwHighDateTime = ft2.u.HighPart;
    FileTimeToSystemTime_k(&lft, systime);
}
 ...
 *  Nothing.
 */
VOID WINAPI GetSystemTime_k(LPSYSTEMTIME systime)
{
    FILETIME ft;
    LARGE_INTEGER t;
    ...
    ft.dwLowDateTime = t.u.LowPart;
    ft.dwHighDateTime = t.u.HighPart;
    FileTimeToSystemTime_k(&ft, systime);
}
 ...
 *  FALSE otherwise.
 */
BOOL WINAPI GetDaylightFlag_k(void)
{
    TIME_ZONE_INFORMATION tzinfo;
    return GetTimeZoneInformation_k( &tzinfo) == TIME_ZONE_ID_DAYLIGHT;
}

/***********************************************************************
 *           DosDateTimeToFileTime   (KERNEL32.@)
 */
BOOL WINAPI DosDateTimeToFileTime_k( WORD fatdate, WORD fattime, LPFILETIME ft)
{
    struct tm newtm;
#ifndef HAVE_TIMEGM
    struct tm *gtm;
    ...
    gtm = gmtime(&time1);
    time2 = mktime(gtm);
    RtlSecondsSince1970ToTime_k((DWORD)(2*time1-time2), (LARGE_INTEGER *)ft );
#endif
    return TRUE;
}
 ...
 */
BOOL WINAPI FileTimeToDosDateTime_k( const FILETIME *ft, LPWORD fatdate,
                                     LPWORD fattime )
{
    LARGE_INTEGER       li;
    ULONG               t;
    ...
    if (!RtlTimeToSecondsSince1970_k( &li, &t ))
    {
        SetLastError_k(ERROR_INVALID_PARAMETER);
        return FALSE;
    }
 ...
 */
BOOL WINAPI GetSystemTimes_k(LPFILETIME lpIdleTime, LPFILETIME lpKernelTime, LPFILETIME lpUserTime)
{
 ...
 */
DWORD WINAPI GetDynamicTimeZoneInformation_k(PDYNAMIC_TIME_ZONE_INFORMATION info)
{
    FIXME("(%p) stub!\n", info);
