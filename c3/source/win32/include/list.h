...
static __inline void list_add_after( struct list *elem, struct list *to_add )
{
...
static __inline struct list *list_prev( const struct list *list, const struct list *elem )
{
...
static __inline struct list *list_tail( const struct list *list )
{
...
static __inline unsigned int list_count( const struct list *list )
{
    unsigned count = 0;
...
static __inline void list_move_tail( struct list *dst, struct list *src )
{
...
static __inline void list_move_head( struct list *dst, struct list *src )
{
    if (list_empty(src)) return;
