...
INT         WINAPI CompareStringA_k(LCID,DWORD,LPCSTR,INT,LPCSTR,INT);
INT         WINAPI CompareStringW_k(LCID,DWORD,LPCWSTR,INT,LPCWSTR,INT);
#define                       CompareString WINELIB_NAME_AW(CompareString)
INT         WINAPI CompareStringEx_k(LPCWSTR,DWORD,LPCWSTR,INT,LPCWSTR,INT,LPNLSVERSIONINFO,LPVOID,LPARAM);
LCID        WINAPI ConvertDefaultLocale_k(LCID);
BOOL        WINAPI EnumCalendarInfoA_k(CALINFO_ENUMPROCA,LCID,CALID,CALTYPE);
BOOL        WINAPI EnumCalendarInfoW_k(CALINFO_ENUMPROCW,LCID,CALID,CALTYPE);
#define                       EnumCalendarInfo WINELIB_NAME_AW(EnumCalendarInfo)
BOOL        WINAPI EnumCalendarInfoExA_k(CALINFO_ENUMPROCEXA,LCID,CALID,CALTYPE);
BOOL        WINAPI EnumCalendarInfoExW_k(CALINFO_ENUMPROCEXW,LCID,CALID,CALTYPE);
#define                       EnumCalendarInfoEx WINELIB_NAME_AW(EnumCalendarInfoEx)
BOOL        WINAPI EnumDateFormatsA_k(DATEFMT_ENUMPROCA,LCID,DWORD);
BOOL        WINAPI EnumDateFormatsW_k(DATEFMT_ENUMPROCW,LCID,DWORD);
#define                       EnumDateFormats WINELIB_NAME_AW(EnumDateFormats)
BOOL        WINAPI EnumDateFormatsExA_k(DATEFMT_ENUMPROCEXA,LCID,DWORD);
BOOL        WINAPI EnumDateFormatsExW_k(DATEFMT_ENUMPROCEXW,LCID,DWORD);
#define                       EnumDateFormatsEx WINELIB_NAME_AW(EnumDateFormatsEx)
BOOL        WINAPI EnumSystemCodePagesA_k(CODEPAGE_ENUMPROCA,DWORD);
BOOL        WINAPI EnumSystemCodePagesW_k(CODEPAGE_ENUMPROCW,DWORD);
#define                       EnumSystemCodePages WINELIB_NAME_AW(EnumSystemCodePages)
BOOL        WINAPI EnumSystemGeoID_k(GEOCLASS,GEOID,GEO_ENUMPROC);
BOOL        WINAPI EnumSystemLocalesA_k(LOCALE_ENUMPROCA,DWORD);
BOOL        WINAPI EnumSystemLocalesW_k(LOCALE_ENUMPROCW,DWORD);
#define                       EnumSystemLocales WINELIB_NAME_AW(EnumSystemLocales)
BOOL        WINAPI EnumSystemLocalesEx_k(LOCALE_ENUMPROCEX,DWORD,LPARAM,LPVOID);
BOOL        WINAPI EnumSystemLanguageGroupsA_k(LANGUAGEGROUP_ENUMPROCA,DWORD,LONG_PTR);
BOOL        WINAPI EnumSystemLanguageGroupsW_k(LANGUAGEGROUP_ENUMPROCW,DWORD,LONG_PTR);
#define                       EnumSystemLanguageGroups WINELIB_NAME_AW(EnumSystemLanguageGroups)
BOOL        WINAPI EnumLanguageGroupLocalesA_k(LANGGROUPLOCALE_ENUMPROCA,LGRPID,DWORD,LONG_PTR);
BOOL        WINAPI EnumLanguageGroupLocalesW_k(LANGGROUPLOCALE_ENUMPROCW,LGRPID,DWORD,LONG_PTR);
#define                       EnumLanguageGroupLocales WINELIB_NAME_AW(EnumLanguageGroupLocales)
BOOL        WINAPI EnumTimeFormatsA_k(TIMEFMT_ENUMPROCA,LCID,DWORD);
BOOL        WINAPI EnumTimeFormatsW_k(TIMEFMT_ENUMPROCW,LCID,DWORD);
#define                       EnumTimeFormats WINELIB_NAME_AW(EnumTimeFormats)
BOOL        WINAPI EnumUILanguagesA_k(UILANGUAGE_ENUMPROCA,DWORD,LONG_PTR);
BOOL        WINAPI EnumUILanguagesW_k(UILANGUAGE_ENUMPROCW,DWORD,LONG_PTR);
#define                       EnumUILanguages WINELIB_NAME_AW(EnumUILanguages)
INT         WINAPI FoldStringA_k(DWORD,LPCSTR,INT,LPSTR,INT);
INT         WINAPI FoldStringW_k(DWORD,LPCWSTR,INT,LPWSTR,INT);
#define                       FoldString WINELIB_NAME_AW(FoldString)
UINT        WINAPI GetACP_k(void);
BOOL        WINAPI GetCPInfo_k(UINT,LPCPINFO);
BOOL        WINAPI GetCPInfoExA_k(UINT,DWORD,LPCPINFOEXA);
BOOL        WINAPI GetCPInfoExW_k(UINT,DWORD,LPCPINFOEXW);
#define                       GetCPInfoEx WINELIB_NAME_AW(GetCPInfoEx)
INT         WINAPI GetCalendarInfoA_k(LCID,DWORD,DWORD,LPSTR,INT,LPDWORD);
INT         WINAPI GetCalendarInfoW_k(LCID,DWORD,DWORD,LPWSTR,INT,LPDWORD);
#define                       GetCalendarInfo WINELIB_NAME_AW(GetCalendarInfo)
INT         WINAPI GetCurrencyFormatA_k(LCID,DWORD,LPCSTR,const CURRENCYFMTA*,LPSTR,INT);
INT         WINAPI GetCurrencyFormatW_k(LCID,DWORD,LPCWSTR,const CURRENCYFMTW*,LPWSTR,INT);
#define                       GetCurrencyFormat WINELIB_NAME_AW(GetCurrencyFormat)
INT         WINAPI GetDateFormatA_k(LCID,DWORD,const SYSTEMTIME*,LPCSTR,LPSTR,INT);
INT         WINAPI GetDateFormatW_k(LCID,DWORD,const SYSTEMTIME*,LPCWSTR,LPWSTR,INT);
#define                       GetDateFormat WINELIB_NAME_AW(GetDateFormat)
INT         WINAPI GetGeoInfoA_k(GEOID,GEOTYPE,LPSTR,INT,LANGID);
INT         WINAPI GetGeoInfoW_k(GEOID,GEOTYPE,LPWSTR,INT,LANGID);
#define                       GetGeoInfo WINELIB_NAME_AW(GetGeoInfo)
INT         WINAPI GetLocaleInfoA_k(LCID,LCTYPE,LPSTR,INT);
INT         WINAPI GetLocaleInfoW_k(LCID,LCTYPE,LPWSTR,INT);
#define                       GetLocaleInfo WINELIB_NAME_AW(GetLocaleInfo)
INT         WINAPI GetNumberFormatA_k(LCID,DWORD,LPCSTR,const NUMBERFMTA*,LPSTR,INT);
INT         WINAPI GetNumberFormatW_k(LCID,DWORD,LPCWSTR,const NUMBERFMTW*,LPWSTR,INT);
#define                       GetNumberFormat WINELIB_NAME_AW(GetNumberFormat)
UINT        WINAPI GetOEMCP_k(void);
BOOL        WINAPI GetStringTypeA_k(LCID,DWORD,LPCSTR,INT,LPWORD);
BOOL        WINAPI GetStringTypeW_k(DWORD,LPCWSTR,INT,LPWORD);
BOOL        WINAPI GetStringTypeExA_k(LCID,DWORD,LPCSTR,INT,LPWORD);
BOOL        WINAPI GetStringTypeExW_k(LCID,DWORD,LPCWSTR,INT,LPWORD);
...
LANGID      WINAPI GetSystemDefaultUILanguage_k(void);
LCID        WINAPI GetThreadLocale_k(void);
INT         WINAPI GetTimeFormatA_k(LCID,DWORD,const SYSTEMTIME*,LPCSTR,LPSTR,INT);
INT         WINAPI GetTimeFormatW_k(LCID,DWORD,const SYSTEMTIME*,LPCWSTR,LPWSTR,INT);
#define                       GetTimeFormat WINELIB_NAME_AW(GetTimeFormat)
LANGID      WINAPI GetUserDefaultLangID_k(void);
LCID        WINAPI GetUserDefaultLCID_k(void);
INT         WINAPI GetUserDefaultLocaleName_k(LPWSTR,int);
LANGID      WINAPI GetUserDefaultUILanguage_k(void);
GEOID       WINAPI GetUserGeoID_k(GEOCLASS);
INT    WINAPI IdnToAscii_k(DWORD,LPCWSTR,INT,LPWSTR,INT);
INT    WINAPI IdnToNameprepUnicode_k(DWORD,LPCWSTR,INT,LPWSTR,INT);
INT    WINAPI IdnToUnicode_k(DWORD,LPCWSTR,INT,LPWSTR,INT);
BOOL        WINAPI IsDBCSLeadByte_k(BYTE);
BOOL        WINAPI IsDBCSLeadByteEx_k(UINT,BYTE);
BOOL   WINAPI IsNormalizedString_k(NORM_FORM,LPCWSTR,INT);
BOOL        WINAPI IsValidCodePage_k(UINT);
BOOL        WINAPI IsValidLocale_k(LCID,DWORD);
BOOL        WINAPI IsValidLanguageGroup_k(LGRPID,DWORD);
INT         WINAPI LCIDToLocaleName_k(LCID,LPWSTR,INT,DWORD);
INT         WINAPI LCMapStringA_k(LCID,DWORD,LPCSTR,INT,LPSTR,INT);
INT         WINAPI LCMapStringW_k(LCID,DWORD,LPCWSTR,INT,LPWSTR,INT);
#define                       LCMapString WINELIB_NAME_AW(LCMapString)
INT         WINAPI LCMapStringEx_k(LPCWSTR,DWORD,LPCWSTR,INT,LPWSTR,INT,LPNLSVERSIONINFO,LPVOID,LPARAM);
LCID        WINAPI LocaleNameToLCID_k(LPCWSTR,DWORD);
INT         WINAPI MultiByteToWideChar_k(UINT,DWORD,LPCSTR,INT,LPWSTR,INT);
INT    WINAPI NormalizeString_k(NORM_FORM,LPCWSTR,INT,LPWSTR,INT);
INT         WINAPI SetCalendarInfoA_k(LCID,CALID,CALTYPE,LPCSTR);
INT         WINAPI SetCalendarInfoW_k(LCID,CALID,CALTYPE,LPCWSTR);
#define                       SetCalendarInfo WINELIB_NAME_AW(SetCalendarInfo)
BOOL        WINAPI SetLocaleInfoA_k(LCID,LCTYPE,LPCSTR);
BOOL        WINAPI SetLocaleInfoW_k(LCID,LCTYPE,LPCWSTR);
#define                       SetLocaleInfo WINELIB_NAME_AW(SetLocaleInfo)
BOOL        WINAPI SetThreadLocale_k(LCID);
BOOL        WINAPI SetUserGeoID_k(GEOID);
INT         WINAPI WideCharToMultiByte_k(UINT,DWORD,LPCWSTR,INT,LPSTR,INT,LPCSTR,LPBOOL);
