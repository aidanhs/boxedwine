...
BOOL WINAPI FontIsLinked_k(HDC);

BOOL WINAPI SetVirtualResolution_k(HDC hdc, DWORD horz_res, DWORD vert_res, DWORD horz_size, DWORD vert_size);
...
static INLINE int get_dib_info_size( const BITMAPINFO *info, UINT coloruse )
{
    ...
    return sizeof(BITMAPINFOHEADER) + info->bmiHeader.biClrUsed * sizeof(RGBQUAD);
}
