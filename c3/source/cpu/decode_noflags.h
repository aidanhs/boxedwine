...
void OPCALL adde8r8_16_noflags(struct CPU* cpu, struct Op* op) {
    ...
    writeb(eaa, readb(eaa) + *cpu->reg8[op->r1]);
    CYCLES(3);
    NEXT();
}
...
void OPCALL addr8e8_16_noflags(struct CPU* cpu, struct Op* op) {
    *cpu->reg8[op->r1] = *cpu->reg8[op->r1] + readb(eaa16(cpu, op));
    CYCLES(2);
    NEXT();
}
void OPCALL addr8e8_32_noflags(struct CPU* cpu, struct Op* op) {
    *cpu->reg8[op->r1] = *cpu->reg8[op->r1] + readb(eaa32(cpu, op));
    CYCLES(2);
    NEXT();
}
...
void OPCALL adde16r16_16_noflags(struct CPU* cpu, struct Op* op) {
    U32 eaa = eaa16(cpu, op);
    writew(eaa, readw(eaa) + cpu->reg[op->r1].u16);
    CYCLES(3);
    NEXT();
}
...
void OPCALL addr16e16_16_noflags(struct CPU* cpu, struct Op* op) {
    cpu->reg[op->r1].u16 = cpu->reg[op->r1].u16 + readw(eaa16(cpu, op));
    CYCLES(2);
    NEXT();
}
void OPCALL addr16e16_32_noflags(struct CPU* cpu, struct Op* op) {
    cpu->reg[op->r1].u16 = cpu->reg[op->r1].u16 + readw(eaa32(cpu, op));
    CYCLES(2);
    NEXT();
}
...
void OPCALL adde32r32_16_noflags(struct CPU* cpu, struct Op* op) {
    U32 eaa = eaa16(cpu, op);
    writed(eaa, readd(eaa) + cpu->reg[op->r1].u32);
    CYCLES(3);
    NEXT();
}
...
void OPCALL addr32e32_16_noflags(struct CPU* cpu, struct Op* op) {
    cpu->reg[op->r1].u32 = cpu->reg[op->r1].u32 + readd(eaa16(cpu, op));
    CYCLES(2);
    NEXT();
}
void OPCALL addr32e32_32_noflags(struct CPU* cpu, struct Op* op) {
    cpu->reg[op->r1].u32 = cpu->reg[op->r1].u32 + readd(eaa32(cpu, op));
    CYCLES(2);
    NEXT();
}
...
void OPCALL adce8r8_16_noflags(struct CPU* cpu, struct Op* op) {
    U32 eaa = eaa16(cpu, op);
    writeb(eaa, readb(eaa) + *cpu->reg8[op->r1] + getCF(cpu));
    CYCLES(3);
    NEXT();
}
...
void OPCALL adcr8e8_16_noflags(struct CPU* cpu, struct Op* op) {
    *cpu->reg8[op->r1] = *cpu->reg8[op->r1] + readb(eaa16(cpu, op)) + getCF(cpu);
    CYCLES(2);
    NEXT();
}
void OPCALL adcr8e8_32_noflags(struct CPU* cpu, struct Op* op) {
    *cpu->reg8[op->r1] = *cpu->reg8[op->r1] + readb(eaa32(cpu, op)) + getCF(cpu);
    CYCLES(2);
    NEXT();
}
...
void OPCALL adc8_mem16_noflags(struct CPU* cpu, struct Op* op) {
    U32 eaa = eaa16(cpu, op);
    writeb(eaa, readb(eaa) + op->data1 + getCF(cpu));
    CYCLES(3);
    NEXT();
}
...
void OPCALL adce16r16_16_noflags(struct CPU* cpu, struct Op* op) {
    U32 eaa = eaa16(cpu, op);
    writew(eaa, readw(eaa) + cpu->reg[op->r1].u16 + getCF(cpu));
    CYCLES(3);
    NEXT();
}
...
void OPCALL adcr16e16_16_noflags(struct CPU* cpu, struct Op* op) {
    cpu->reg[op->r1].u16 = cpu->reg[op->r1].u16 + readw(eaa16(cpu, op)) + getCF(cpu);
    CYCLES(2);
    NEXT();
}
void OPCALL adcr16e16_32_noflags(struct CPU* cpu, struct Op* op) {
    cpu->reg[op->r1].u16 = cpu->reg[op->r1].u16 + readw(eaa32(cpu, op)) + getCF(cpu);
    CYCLES(2);
    NEXT();
}
...
void OPCALL adc16_mem16_noflags(struct CPU* cpu, struct Op* op) {
    U32 eaa = eaa16(cpu, op);
    writew(eaa, readw(eaa) + op->data1 + getCF(cpu));
    CYCLES(3);
    NEXT();
}
...
void OPCALL adce32r32_16_noflags(struct CPU* cpu, struct Op* op) {
    U32 eaa = eaa16(cpu, op);
    writed(eaa, readd(eaa) + cpu->reg[op->r1].u32 + getCF(cpu));
    CYCLES(3);
    NEXT();
}
...
void OPCALL adcr32e32_16_noflags(struct CPU* cpu, struct Op* op) {
    cpu->reg[op->r1].u32 = cpu->reg[op->r1].u32 + readd(eaa16(cpu, op)) + getCF(cpu);
    CYCLES(2);
    NEXT();
}
void OPCALL adcr32e32_32_noflags(struct CPU* cpu, struct Op* op) {
    cpu->reg[op->r1].u32 = cpu->reg[op->r1].u32 + readd(eaa32(cpu, op)) + getCF(cpu);
    CYCLES(2);
    NEXT();
}
...
void OPCALL adc32_mem16_noflags(struct CPU* cpu, struct Op* op) {
    U32 eaa = eaa16(cpu, op);
    writed(eaa, readd(eaa) + op->data1 + getCF(cpu));
    CYCLES(3);
    NEXT();
}
