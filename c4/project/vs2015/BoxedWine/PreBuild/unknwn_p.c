...
/* Standard interface: __MIDL_itf_unknwn_0000_0000, ver. 0.0,
...
/* Standard interface: __MIDL_itf_unknwn_0000_0001, ver. 0.0,
   GUID={0x00000000,0x0000,0x0000,{0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00}} */
...
const CInterfaceProxyVtbl * const _unknwn_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_IClassFactoryProxyVtbl,
    0
};

const CInterfaceStubVtbl * const _unknwn_StubVtblList[] = 
{
